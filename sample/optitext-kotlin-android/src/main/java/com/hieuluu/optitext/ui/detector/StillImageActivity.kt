...
package com.hieuluu.optitext.ui.detector
...
import com.hieuluu.optitext.base.BaseActivity
import com.hieuluu.optitext.base.ViewController
import com.hieuluu.optitext.base.textrecognition.BitmapUtils
import com.hieuluu.optitext.base.textrecognition.GraphicOverlay
import com.hieuluu.optitext.base.textrecognition.VisionImageProcessor
import com.hieuluu.optitext.base.textrecognition.textdetector.TextRecognitionProcessor
import com.hieuluu.optitext.databinding.ActivityStillImageBinding
import com.hieuluu.optitext.ui.preference.SettingsActivity
...
class StillImageActivity : BaseActivity() {
  ...
  private lateinit var viewModel: StillImageViewModel
...
//    val binding = ActivityStillImageBinding.inflate(layoutInflater)
...
//  }
  ...
  override fun getBinding(inflater: LayoutInflater): ViewBinding {
    return ActivityStillImageBinding.inflate(inflater)
  }
  ...
  override fun setupViewModel() {
    viewModel = getViewModelProvider()[StillImageViewModel::class.java]
  }

  override fun initView() {
    binding = mBinding as ActivityStillImageBinding
    ...
    binding.root.viewTreeObserver.addOnGlobalLayoutListener(
      object : ViewTreeObserver.OnGlobalLayoutListener {
        override fun onGlobalLayout() {
          ...
          imageMaxHeight =
            binding.root.height - findViewById<View>(R.id.control).height
          if (SIZE_SCREEN == selectedSize) {
            tryReloadAndDetectInImage()
          }
        }
...
//    options.add(FACE_MESH_DETECTION);
  ...
  private fun tryReloadAndDetectInImage() {
    Log.d(
      TAG, "Try reload and detect image"
    )
    try {
      if (imageUri == null) {
        return
